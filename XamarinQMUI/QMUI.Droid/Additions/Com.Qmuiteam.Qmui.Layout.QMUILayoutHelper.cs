...
namespace Com.Qmuiteam.Qmui.Layout {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']"
	[global::Android.Runtime.Register ("com/qmuiteam/qmui/layout/QMUILayoutHelper", DoNotGenerateAcw=true)]
	public partial class QMUILayoutHelper : global::Java.Lang.Object, global::Com.Qmuiteam.Qmui.Layout.IQMUILayout {


		// Metadata.xml XPath field reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/field[@name='RADIUS_OF_HALF_VIEW_HEIGHT']"
		[Register ("RADIUS_OF_HALF_VIEW_HEIGHT")]
		public const int RadiusOfHalfViewHeight = (int) -1;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/field[@name='RADIUS_OF_HALF_VIEW_WIDTH']"
		[Register ("RADIUS_OF_HALF_VIEW_WIDTH")]
		public const int RadiusOfHalfViewWidth = (int) -2;
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/qmuiteam/qmui/layout/QMUILayoutHelper", typeof (QMUILayoutHelper));
		...
		protected QMUILayoutHelper (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/constructor[@name='QMUILayoutHelper' and count(parameter)=4 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.util.AttributeSet'] and parameter[3][@type='int'] and parameter[4][@type='android.view.View']]"
		[Register (".ctor", "(Landroid/content/Context;Landroid/util/AttributeSet;ILandroid/view/View;)V", "")]
		public unsafe QMUILayoutHelper (global::Android.Content.Context context, global::Android.Util.IAttributeSet attrs, int defAttr, global::Android.Views.View owner)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [3] = new JniArgumentValue ((owner == null) ? IntPtr.Zero : ((global::Java.Lang.Object) owner).Handle);
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/constructor[@name='QMUILayoutHelper' and count(parameter)=5 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.util.AttributeSet'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='android.view.View']]"
		[Register (".ctor", "(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/view/View;)V", "")]
		public unsafe QMUILayoutHelper (global::Android.Content.Context context, global::Android.Util.IAttributeSet attrs, int defAttr, int defStyleRes, global::Android.Views.View owner)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/view/View;)V";
			...
			try {
				...
				__args [4] = new JniArgumentValue ((owner == null) ? IntPtr.Zero : ((global::Java.Lang.Object) owner).Handle);
				var __r = _members.InstanceMethods.StartCreateInstance (__id, ((object) this).GetType (), __args);
				SetHandle (__r.Handle, JniHandleOwnership.TransferLocalRef);
				_members.InstanceMethods.FinishCreateInstance (__id, this, __args);
			} finally {
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Qmuiteam.Qmui.Layout.QMUILayoutHelper> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.HasBorder;
		}
#pragma warning restore 0169

		public virtual unsafe bool HasBorder {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='hasBorder' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe bool HasBottomSeparator {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='hasBottomSeparator' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe bool HasLeftSeparator {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='hasLeftSeparator' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe bool HasRightSeparator {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='hasRightSeparator' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe bool HasTopSeparator {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='hasTopSeparator' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int HideRadiusSide {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='getHideRadiusSide' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setHideRadiusSide' and count(parameter)=1 and parameter[1][@type='int']]"
		...
		static Delegate cb_isRadiusWithSideHidden;
#pragma warning disable 0169
		static Delegate GetIsRadiusWithSideHiddenHandler ()
		{
			if (cb_isRadiusWithSideHidden == null)
				cb_isRadiusWithSideHidden = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_Z) n_IsRadiusWithSideHidden);
			return cb_isRadiusWithSideHidden;
		}

		static bool n_IsRadiusWithSideHidden (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Qmuiteam.Qmui.Layout.QMUILayoutHelper> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.IsRadiusWithSideHidden;
		}
#pragma warning restore 0169

		public virtual unsafe bool IsRadiusWithSideHidden {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='isRadiusWithSideHidden' and count(parameter)=0]"
			[Register ("isRadiusWithSideHidden", "()Z", "GetIsRadiusWithSideHiddenHandler")]
			get {
				const string __id = "isRadiusWithSideHidden.()Z";
				try {
					var __rm = _members.InstanceMethods.InvokeVirtualBooleanMethod (__id, this, null);
					return __rm;
				} finally {
...
#pragma warning restore 0169
		...
		public virtual unsafe int Radius {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='getRadius' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setRadius' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe float ShadowAlpha {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='getShadowAlpha' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setShadowAlpha' and count(parameter)=1 and parameter[1][@type='float']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int ShadowColor {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='getShadowColor' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setShadowColor' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		public virtual unsafe int ShadowElevation {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='getShadowElevation' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setShadowElevation' and count(parameter)=1 and parameter[1][@type='int']]"
		...
		static Delegate cb_dispatchRoundBorderDraw_Landroid_graphics_Canvas_;
#pragma warning disable 0169
		static Delegate GetDispatchRoundBorderDraw_Landroid_graphics_Canvas_Handler ()
		{
			if (cb_dispatchRoundBorderDraw_Landroid_graphics_Canvas_ == null)
				cb_dispatchRoundBorderDraw_Landroid_graphics_Canvas_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_V) n_DispatchRoundBorderDraw_Landroid_graphics_Canvas_);
			return cb_dispatchRoundBorderDraw_Landroid_graphics_Canvas_;
		}

		static void n_DispatchRoundBorderDraw_Landroid_graphics_Canvas_ (IntPtr jnienv, IntPtr native__this, IntPtr native_canvas)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Qmuiteam.Qmui.Layout.QMUILayoutHelper> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			...
			__this.DispatchRoundBorderDraw (canvas);
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='dispatchRoundBorderDraw' and count(parameter)=1 and parameter[1][@type='android.graphics.Canvas']]"
		[Register ("dispatchRoundBorderDraw", "(Landroid/graphics/Canvas;)V", "GetDispatchRoundBorderDraw_Landroid_graphics_Canvas_Handler")]
		public virtual unsafe void DispatchRoundBorderDraw (global::Android.Graphics.Canvas canvas)
		{
			const string __id = "dispatchRoundBorderDraw.(Landroid/graphics/Canvas;)V";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
		...
		static Delegate cb_drawDividers_Landroid_graphics_Canvas_II;
#pragma warning disable 0169
		static Delegate GetDrawDividers_Landroid_graphics_Canvas_IIHandler ()
		{
			if (cb_drawDividers_Landroid_graphics_Canvas_II == null)
				cb_drawDividers_Landroid_graphics_Canvas_II = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPLII_V) n_DrawDividers_Landroid_graphics_Canvas_II);
			return cb_drawDividers_Landroid_graphics_Canvas_II;
		}

		static void n_DrawDividers_Landroid_graphics_Canvas_II (IntPtr jnienv, IntPtr native__this, IntPtr native_canvas, int w, int h)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Qmuiteam.Qmui.Layout.QMUILayoutHelper> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			var canvas = global::Java.Lang.Object.GetObject<global::Android.Graphics.Canvas> (native_canvas, JniHandleOwnership.DoNotTransfer);
			__this.DrawDividers (canvas, w, h);
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='drawDividers' and count(parameter)=3 and parameter[1][@type='android.graphics.Canvas'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
		[Register ("drawDividers", "(Landroid/graphics/Canvas;II)V", "GetDrawDividers_Landroid_graphics_Canvas_IIHandler")]
		public virtual unsafe void DrawDividers (global::Android.Graphics.Canvas canvas, int w, int h)
		{
			const string __id = "drawDividers.(Landroid/graphics/Canvas;II)V";
			try {
		...
		static Delegate cb_getMeasuredHeightSpec_I;
#pragma warning disable 0169
		static Delegate GetGetMeasuredHeightSpec_IHandler ()
		{
			if (cb_getMeasuredHeightSpec_I == null)
				cb_getMeasuredHeightSpec_I = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPI_I) n_GetMeasuredHeightSpec_I);
			return cb_getMeasuredHeightSpec_I;
		}

		static int n_GetMeasuredHeightSpec_I (IntPtr jnienv, IntPtr native__this, int heightMeasureSpec)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Qmuiteam.Qmui.Layout.QMUILayoutHelper> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.GetMeasuredHeightSpec (heightMeasureSpec);
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='getMeasuredHeightSpec' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("getMeasuredHeightSpec", "(I)I", "GetGetMeasuredHeightSpec_IHandler")]
		public virtual unsafe int GetMeasuredHeightSpec (int heightMeasureSpec)
		{
			const string __id = "getMeasuredHeightSpec.(I)I";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue (heightMeasureSpec);
		...
		static Delegate cb_getMeasuredWidthSpec_I;
#pragma warning disable 0169
		static Delegate GetGetMeasuredWidthSpec_IHandler ()
		{
			if (cb_getMeasuredWidthSpec_I == null)
				cb_getMeasuredWidthSpec_I = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPI_I) n_GetMeasuredWidthSpec_I);
			return cb_getMeasuredWidthSpec_I;
		}

		static int n_GetMeasuredWidthSpec_I (IntPtr jnienv, IntPtr native__this, int widthMeasureSpec)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Qmuiteam.Qmui.Layout.QMUILayoutHelper> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.GetMeasuredWidthSpec (widthMeasureSpec);
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='getMeasuredWidthSpec' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("getMeasuredWidthSpec", "(I)I", "GetGetMeasuredWidthSpec_IHandler")]
		public virtual unsafe int GetMeasuredWidthSpec (int widthMeasureSpec)
		{
			const string __id = "getMeasuredWidthSpec.(I)I";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
		...
		static Delegate cb_handleMiniHeight_II;
#pragma warning disable 0169
		static Delegate GetHandleMiniHeight_IIHandler ()
		{
			if (cb_handleMiniHeight_II == null)
				cb_handleMiniHeight_II = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPII_I) n_HandleMiniHeight_II);
			return cb_handleMiniHeight_II;
		}

		static int n_HandleMiniHeight_II (IntPtr jnienv, IntPtr native__this, int heightMeasureSpec, int measuredHeight)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Qmuiteam.Qmui.Layout.QMUILayoutHelper> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.HandleMiniHeight (heightMeasureSpec, measuredHeight);
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='handleMiniHeight' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register ("handleMiniHeight", "(II)I", "GetHandleMiniHeight_IIHandler")]
		public virtual unsafe int HandleMiniHeight (int heightMeasureSpec, int measuredHeight)
		{
			const string __id = "handleMiniHeight.(II)I";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [2];
				__args [0] = new JniArgumentValue (heightMeasureSpec);
				__args [1] = new JniArgumentValue (measuredHeight);
				var __rm = _members.InstanceMethods.InvokeVirtualInt32Method (__id, this, __args);
				return __rm;
			} finally {
			}
		...
		static Delegate cb_handleMiniWidth_II;
#pragma warning disable 0169
		static Delegate GetHandleMiniWidth_IIHandler ()
		{
			if (cb_handleMiniWidth_II == null)
				cb_handleMiniWidth_II = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPII_I) n_HandleMiniWidth_II);
			return cb_handleMiniWidth_II;
		}

		static int n_HandleMiniWidth_II (IntPtr jnienv, IntPtr native__this, int widthMeasureSpec, int measuredWidth)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Qmuiteam.Qmui.Layout.QMUILayoutHelper> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.HandleMiniWidth (widthMeasureSpec, measuredWidth);
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='handleMiniWidth' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register ("handleMiniWidth", "(II)I", "GetHandleMiniWidth_IIHandler")]
		public virtual unsafe int HandleMiniWidth (int widthMeasureSpec, int measuredWidth)
		{
			const string __id = "handleMiniWidth.(II)I";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [2];
				__args [0] = new JniArgumentValue (widthMeasureSpec);
				__args [1] = new JniArgumentValue (measuredWidth);
				var __rm = _members.InstanceMethods.InvokeVirtualInt32Method (__id, this, __args);
				return __rm;
			} finally {
			}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='onlyShowBottomDivider' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='onlyShowLeftDivider' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='onlyShowRightDivider' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='onlyShowTopDivider' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setBorderColor' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setBorderWidth' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setBottomDividerAlpha' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setHeightLimit' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setLeftDividerAlpha' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setOuterNormalColor' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setOutlineExcludePadding' and count(parameter)=1 and parameter[1][@type='boolean']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setOutlineInset' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setRadius' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setRadiusAndShadow' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='float']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setRadiusAndShadow' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='float']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setRadiusAndShadow' and count(parameter)=5 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='float']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setRightDividerAlpha' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setShowBorderOnlyBeforeL' and count(parameter)=1 and parameter[1][@type='boolean']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setTopDividerAlpha' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setUseThemeGeneralShadowElevation' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='setWidthLimit' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='updateBottomDivider' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='updateBottomSeparatorColor' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='updateLeftDivider' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='updateLeftSeparatorColor' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='updateRightDivider' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='updateRightSeparatorColor' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='updateTopDivider' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='updateTopSeparatorColor' and count(parameter)=1 and parameter[1][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.layout']/class[@name='QMUILayoutHelper']/method[@name='useFeature' and count(parameter)=0]"
		[Register ("useFeature", "()Z", "")]
		public static unsafe bool UseFeature ()
		{
			const string __id = "useFeature.()Z";
			try {
