...
namespace Com.Qmuiteam.Qmui.Span {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qmuiteam.qmui.span']/class[@name='QMUITextSizeSpan']"
	[global::Android.Runtime.Register ("com/qmuiteam/qmui/span/QMUITextSizeSpan", DoNotGenerateAcw=true)]
	public partial class QMUITextSizeSpan : global::Android.Text.Style.ReplacementSpan {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/qmuiteam/qmui/span/QMUITextSizeSpan", typeof (QMUITextSizeSpan));
		...
		protected QMUITextSizeSpan (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qmuiteam.qmui.span']/class[@name='QMUITextSizeSpan']/constructor[@name='QMUITextSizeSpan' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='int']]"
		[Register (".ctor", "(II)V", "")]
		public unsafe QMUITextSizeSpan (int textSize, int verticalOffset)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				__args [1] = new JniArgumentValue (verticalOffset);
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qmuiteam.qmui.span']/class[@name='QMUITextSizeSpan']/constructor[@name='QMUITextSizeSpan' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='android.graphics.Typeface']]"
		[Register (".ctor", "(IILandroid/graphics/Typeface;)V", "")]
		public unsafe QMUITextSizeSpan (int textSize, int verticalOffset, global::Android.Graphics.Typeface typeface)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "(IILandroid/graphics/Typeface;)V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Qmuiteam.Qmui.Span.QMUITextSizeSpan> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.span']/class[@name='QMUITextSizeSpan']/method[@name='draw' and count(parameter)=9 and parameter[1][@type='android.graphics.Canvas'] and parameter[2][@type='java.lang.CharSequence'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='float'] and parameter[6][@type='int'] and parameter[7][@type='int'] and parameter[8][@type='int'] and parameter[9][@type='android.graphics.Paint']]"
