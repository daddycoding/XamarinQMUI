...
namespace Com.Qmuiteam.Qmui.Skin.Handler {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qmuiteam.qmui.skin.handler']/class[@name='QMUISkinRuleHintColorHandler']"
	[global::Android.Runtime.Register ("com/qmuiteam/qmui/skin/handler/QMUISkinRuleHintColorHandler", DoNotGenerateAcw=true)]
	public partial class QMUISkinRuleHintColorHandler : global::Com.Qmuiteam.Qmui.Skin.Handler.QMUISkinRuleColorStateListHandler {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/qmuiteam/qmui/skin/handler/QMUISkinRuleHintColorHandler", typeof (QMUISkinRuleHintColorHandler));
		...
		protected QMUISkinRuleHintColorHandler (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qmuiteam.qmui.skin.handler']/class[@name='QMUISkinRuleHintColorHandler']/constructor[@name='QMUISkinRuleHintColorHandler' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe QMUISkinRuleHintColorHandler ()
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Qmuiteam.Qmui.Skin.Handler.QMUISkinRuleHintColorHandler> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
