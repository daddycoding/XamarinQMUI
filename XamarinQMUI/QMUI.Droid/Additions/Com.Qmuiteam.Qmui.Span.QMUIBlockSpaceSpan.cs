...
namespace Com.Qmuiteam.Qmui.Span {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qmuiteam.qmui.span']/class[@name='QMUIBlockSpaceSpan']"
	[global::Android.Runtime.Register ("com/qmuiteam/qmui/span/QMUIBlockSpaceSpan", DoNotGenerateAcw=true)]
	public partial class QMUIBlockSpaceSpan : global::Android.Text.Style.ReplacementSpan {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/qmuiteam/qmui/span/QMUIBlockSpaceSpan", typeof (QMUIBlockSpaceSpan));
		...
		protected QMUIBlockSpaceSpan (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qmuiteam.qmui.span']/class[@name='QMUIBlockSpaceSpan']/constructor[@name='QMUIBlockSpaceSpan' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register (".ctor", "(I)V", "")]
		public unsafe QMUIBlockSpaceSpan (int height)
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Qmuiteam.Qmui.Span.QMUIBlockSpaceSpan> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.span']/class[@name='QMUIBlockSpaceSpan']/method[@name='draw' and count(parameter)=9 and parameter[1][@type='android.graphics.Canvas'] and parameter[2][@type='java.lang.CharSequence'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='float'] and parameter[6][@type='int'] and parameter[7][@type='int'] and parameter[8][@type='int'] and parameter[9][@type='android.graphics.Paint']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.span']/class[@name='QMUIBlockSpaceSpan']/method[@name='getSize' and count(parameter)=5 and parameter[1][@type='android.graphics.Paint'] and parameter[2][@type='java.lang.CharSequence'] and parameter[3][@type='int'] and parameter[4][@type='int'] and parameter[5][@type='android.graphics.Paint.FontMetricsInt']]"
