...
namespace Com.Qmuiteam.Qmui.Widget.PullLayout {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qmuiteam.qmui.widget.pullLayout']/class[@name='QMUIAlwaysFollowOffsetCalculator']"
	[global::Android.Runtime.Register ("com/qmuiteam/qmui/widget/pullLayout/QMUIAlwaysFollowOffsetCalculator", DoNotGenerateAcw=true)]
	public partial class QMUIAlwaysFollowOffsetCalculator : global::Java.Lang.Object, global::Com.Qmuiteam.Qmui.Widget.PullLayout.QMUIPullLayout.IActionViewOffsetCalculator {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/qmuiteam/qmui/widget/pullLayout/QMUIAlwaysFollowOffsetCalculator", typeof (QMUIAlwaysFollowOffsetCalculator));
		...
		protected QMUIAlwaysFollowOffsetCalculator (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qmuiteam.qmui.widget.pullLayout']/class[@name='QMUIAlwaysFollowOffsetCalculator']/constructor[@name='QMUIAlwaysFollowOffsetCalculator' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe QMUIAlwaysFollowOffsetCalculator ()
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Qmuiteam.Qmui.Widget.PullLayout.QMUIAlwaysFollowOffsetCalculator> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.qmuiteam.qmui.widget.pullLayout']/class[@name='QMUIAlwaysFollowOffsetCalculator']/method[@name='calculateOffset' and count(parameter)=2 and parameter[1][@type='com.qmuiteam.qmui.widget.pullLayout.QMUIPullLayout.PullAction'] and parameter[2][@type='int']]"
