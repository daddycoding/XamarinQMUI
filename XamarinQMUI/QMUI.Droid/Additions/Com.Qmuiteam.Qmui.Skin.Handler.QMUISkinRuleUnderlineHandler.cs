...
namespace Com.Qmuiteam.Qmui.Skin.Handler {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qmuiteam.qmui.skin.handler']/class[@name='QMUISkinRuleUnderlineHandler']"
	[global::Android.Runtime.Register ("com/qmuiteam/qmui/skin/handler/QMUISkinRuleUnderlineHandler", DoNotGenerateAcw=true)]
	public partial class QMUISkinRuleUnderlineHandler : global::Com.Qmuiteam.Qmui.Skin.Handler.QMUISkinRuleColorStateListHandler {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/qmuiteam/qmui/skin/handler/QMUISkinRuleUnderlineHandler", typeof (QMUISkinRuleUnderlineHandler));
		...
		protected QMUISkinRuleUnderlineHandler (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qmuiteam.qmui.skin.handler']/class[@name='QMUISkinRuleUnderlineHandler']/constructor[@name='QMUISkinRuleUnderlineHandler' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe QMUISkinRuleUnderlineHandler ()
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Qmuiteam.Qmui.Skin.Handler.QMUISkinRuleUnderlineHandler> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
