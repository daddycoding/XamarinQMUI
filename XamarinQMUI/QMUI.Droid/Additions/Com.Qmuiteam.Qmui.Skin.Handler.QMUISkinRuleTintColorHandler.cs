...
namespace Com.Qmuiteam.Qmui.Skin.Handler {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.qmuiteam.qmui.skin.handler']/class[@name='QMUISkinRuleTintColorHandler']"
	[global::Android.Runtime.Register ("com/qmuiteam/qmui/skin/handler/QMUISkinRuleTintColorHandler", DoNotGenerateAcw=true)]
	public partial class QMUISkinRuleTintColorHandler : global::Com.Qmuiteam.Qmui.Skin.Handler.QMUISkinRuleColorStateListHandler {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/qmuiteam/qmui/skin/handler/QMUISkinRuleTintColorHandler", typeof (QMUISkinRuleTintColorHandler));
		...
		protected QMUISkinRuleTintColorHandler (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.qmuiteam.qmui.skin.handler']/class[@name='QMUISkinRuleTintColorHandler']/constructor[@name='QMUISkinRuleTintColorHandler' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe QMUISkinRuleTintColorHandler ()
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Qmuiteam.Qmui.Skin.Handler.QMUISkinRuleTintColorHandler> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
