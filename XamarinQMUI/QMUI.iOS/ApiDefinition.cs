...
namespace QMUI.iOS
{
	...
	interface QMUIHelper_UIGraphic
	{
		...
		unsafe void InspectContextIfInvalidatedInDebugMode(CGContextRef* context);
		...
		unsafe bool InspectContextIfInvalidatedInReleaseMode(CGContextRef* context);
	}
	...
	interface QMUIPropertyDescriptor
	{
		...
		unsafe QMUIPropertyDescriptor DescriptorWithProperty(objc_property_t* property);
	}
	...
	interface QMUITips
	{
		...
		QMUITips ShowWithText([NullAllowed] string text, UIView view, double delay);
		...
		QMUITips ShowWithText([NullAllowed] string text, [NullAllowed] string detailText, UIView view);
		...
		QMUITips ShowWithText([NullAllowed] string text, [NullAllowed] string detailText, UIView view, double delay);

		// +(QMUITips * _Nonnull)showSucceed:(NSString * _Nullable)text;
		[Static]
		[Export("showSucceed:")]
		QMUITips ShowSucceed([NullAllowed] string text);

		// +(QMUITips * _Nonnull)showSucceed:(NSString * _Nullable)text detailText:(NSString * _Nullable)detailText;
		[Static]
		[Export("showSucceed:detailText:")]
		QMUITips ShowSucceed([NullAllowed] string text, [NullAllowed] string detailText);

		// +(QMUITips * _Nonnull)showSucceed:(NSString * _Nullable)text inView:(UIView * _Nonnull)view;
		[Static]
		[Export("showSucceed:inView:")]
		QMUITips ShowSucceed([NullAllowed] string text, UIView view);
		...
		QMUITips ShowSucceed([NullAllowed] string text, UIView view, double delay);
		...
		QMUITips ShowSucceed([NullAllowed] string text, [NullAllowed] string detailText, UIView view);
		...
		QMUITips ShowSucceed([NullAllowed] string text, [NullAllowed] string detailText, UIView view, double delay);

		// +(QMUITips * _Nonnull)showError:(NSString * _Nullable)text;
		[Static]
		[Export("showError:")]
		QMUITips ShowError([NullAllowed] string text);

		// +(QMUITips * _Nonnull)showError:(NSString * _Nullable)text detailText:(NSString * _Nullable)detailText;
		[Static]
		[Export("showError:detailText:")]
		QMUITips ShowError([NullAllowed] string text, [NullAllowed] string detailText);

		// +(QMUITips * _Nonnull)showError:(NSString * _Nullable)text inView:(UIView * _Nonnull)view;
		[Static]
		[Export("showError:inView:")]
		QMUITips ShowError([NullAllowed] string text, UIView view);
		...
		QMUITips ShowError([NullAllowed] string text, UIView view, double delay);
		...
		QMUITips ShowError([NullAllowed] string text, [NullAllowed] string detailText, UIView view);
		...
		QMUITips ShowError([NullAllowed] string text, [NullAllowed] string detailText, UIView view, double delay);

		// +(QMUITips * _Nonnull)showInfo:(NSString * _Nullable)text;
		[Static]
		[Export("showInfo:")]
		QMUITips ShowInfo([NullAllowed] string text);

		// +(QMUITips * _Nonnull)showInfo:(NSString * _Nullable)text detailText:(NSString * _Nullable)detailText;
		[Static]
		[Export("showInfo:detailText:")]
		QMUITips ShowInfo([NullAllowed] string text, [NullAllowed] string detailText);

		// +(QMUITips * _Nonnull)showInfo:(NSString * _Nullable)text inView:(UIView * _Nonnull)view;
		[Static]
		[Export("showInfo:inView:")]
		QMUITips ShowInfo([NullAllowed] string text, UIView view);
		...
		QMUITips ShowInfo([NullAllowed] string text, UIView view, double delay);
		...
		QMUITips ShowInfo([NullAllowed] string text, [NullAllowed] string detailText, UIView view);
		...
		QMUITips ShowInfo([NullAllowed] string text, [NullAllowed] string detailText, UIView view, double delay);
	...
	interface UIImage_QMUI
	{
		...
		[return: NullAllowed]
		unsafe UIImage Qmui_imageWithSize(CGSize size, bool opaque, nfloat scale, Action<CoreGraphics.CGContextRef*> actionBlock);
